(function () {
  ...
  var main = function main() {
    ...
    var tabsMobile = document.querySelectorAll(".tabs__controls--mobile .tabs__wrapper .tabs__control"); // console.log(tabsDesktop);
    ...
    function checkScroll() {
      ...
      for (var i = 0; i < videos.length; i++) {
        if (i === 0 || i === 5 || i === 6) {
          ...
          //   videos[i].play();
          // });
          var x = videos[i].offsetLeft,
              _y = videos[i].offsetTop,
          ...
          visibleY = Math.max(0, Math.min(h, window.pageYOffset + window.innerHeight - _y, b - window.pageYOffset));
          visible = visibleX * visibleY / (w * h); // console.log('video:', i);
  ...
  var windowsChoiceSelector = document.getElementById('choice-windows');
  var linuxChoiceSelector = document.getElementById('choice-linux');
  var macosChoiceSelector = document.getElementById('choice-macos');
  ...
  if (windowsChoiceSelector) {
    ...
    var windowsChoice = new Choices(windowsChoiceSelector, choiceOptions);
    var linuxChoice = new Choices(linuxChoiceSelector, choiceOptions);
    var macosChoice = new Choices(macosChoiceSelector, choiceOptions);
  }
